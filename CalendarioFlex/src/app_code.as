package
{
	...
	public class app_code extends Application
	{
		...
		protected static const displayOptions:Array = ['mês','semana','dia'];
		...
		[Bindable] public var voltar:Function;
		
		protected function addCalendar():void{
			var createDlg:CreateCalendarDialog = new CreateCalendarDialog();
			
			createDlg.addCalendarTime = function(dlg:CreateCalendarDialog):void{
				addCalendarTime( dlg.dfData.selectedDate, dlg.dfData.selectedDate, 'Reunião', 'URC: ' + dlg.cbURC.selectedItem.nome, dlg.colorUI.selectedColor );
			}
		...
		protected function formatDate(d:Date):String
		{
			...
			r += '' + d.date + ' de ' + chooser.monthNames[d.month] + ' de ' + d.fullYear;
			return r;
		}
